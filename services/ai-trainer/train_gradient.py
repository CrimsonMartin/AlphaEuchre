...
Examples:
  ...
  DATABASE_URL="postgresql://user:pass@host:5432/db" python train_gradient.py
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="How often to update self-play opponent (default: 20 updates)",
    )

    parser.add_argument(
        "--use-critic",
        action="store_true",
        help="Use a critic network for Actor-Critic variance reduction",
    )
    ...
    if args.use_critic:
        try:
            ...
            print(f"Critic Network:     Enabled (lr={args.critic_lr})")
        except ImportError:
    ...
    try:
        for update in range(1, args.num_updates + 1):
            ...
            # Print statistics with diagnostics
